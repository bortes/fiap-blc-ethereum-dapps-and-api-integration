...
contract Wadaag {
    ...
    uint8  public constant maxOwners = 201;             //Número máximo de owners - calculado com base nas transferencias / depósitos em batch
    ...
    function _addOwner(address account, uint256 shareRatio) internal returns (bool) {
        ...
        require(owners.length < maxOwners, "max owners");
    ...
    function _receive(address account) internal {
        require(totalOwner[account] > 0, "no shares");
